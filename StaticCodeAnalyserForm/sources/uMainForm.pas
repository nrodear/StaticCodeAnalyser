...
uses
  ...
  uMethodd12, uSCAConsts, uFixHint,
  Vcl.Controls
 ;
...
// kann: Befund-Metadaten + FixHint (Vorher/Nachher) + Code-Auszug
// (+/-5 Zeilen) aus der Quelldatei mit hervorgehobener Befund-Zeile.
const
  CONTEXT_LINES = 5;
