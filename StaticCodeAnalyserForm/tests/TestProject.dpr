...
uses
  ...
  uTestBaselineJson in 'uTestBaselineJson.pas',
  ...
  uTestInsecureRandom in 'uTestInsecureRandom.pas',
  uTestDefaultCaseInCaseStatement in 'uTestDefaultCaseInCaseStatement.pas',
  uTestAssertWithSideEffect in 'uTestAssertWithSideEffect.pas',
  uTestConstStringParameter in 'uTestConstStringParameter.pas',
  uTestCompilerDirectiveScope in 'uTestCompilerDirectiveScope.pas',
  uTestBooleanPropertyNaming in 'uTestBooleanPropertyNaming.pas',
  uTestVariantTypeMisuse in 'uTestVariantTypeMisuse.pas',
  uTestTObjectListWithoutOwnership in 'uTestTObjectListWithoutOwnership.pas',
  uTestAnonMethodCaptureLoopVar in 'uTestAnonMethodCaptureLoopVar.pas',
