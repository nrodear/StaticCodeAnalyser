...
begin
  ...
  try Assert.AreEqual(1, TFindingHelper.Count(F, fkReRaiseException));
  finally F.Free; end;
end;
...
begin
  F := TFindingHelper.FindingsOf(SRC);
  try Assert.AreEqual(2, TFindingHelper.Count(F, fkReRaiseException));
  finally F.Free; end;
end;
...
begin
  F := TFindingHelper.FindingsOf(SRC);
  try Assert.AreEqual(0, TFindingHelper.Count(F, fkReRaiseException));
  finally F.Free; end;
end;
