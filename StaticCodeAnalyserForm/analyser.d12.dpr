...
uses
  ...
  uParser in 'sources\Parsing\uParser.pas',
  ...
  uStaticAnalyzer in 'sources\Infrastructure\uStaticAnalyzer.pas',
  ...
  uLeakDetector in 'sources\Detectors\uLeakDetector.pas',
