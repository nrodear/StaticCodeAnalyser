...
begin
  ...
  var WidestEnd  : Integer := AnchorLine;
  for j := 0 to Group.Count - 1 do
    if Group[j].EndLine > WidestEnd then WidestEnd := Group[j].EndLine;
...
begin
  ...
  // einen Befund.
  if HasMark and (Mark.Badge <> '') and (TextEndX > 0)
