# Regeneriert NUR die contains-Klausel von SCA.Engine\SCA.Engine.dpk
# aus SCA.Engine\sources\**\*.pas.
#
# NEUFASSUNG 2026-09-05: die alte Fassung schrieb die GANZE Datei aus
# einem Standardkopf neu und zerstoerte dabei den handgepflegten Kopf
# samt der requires-Begruendungen (deshalb stand sie seit 2026-08-16
# als DEFEKT in den Notizen; Projektdateien wurden von Hand gepflegt).
# Jetzt wird die Datei byte-erhaltend gelesen (Latin-1-Roundtrip,
# verlustfrei je Byte) und ausschliesslich der Text zwischen "contains"
# und dem naechsten ";" ersetzt - Kopf, requires, Kommentare und
# Zeilenenden bleiben unangetastet. Idempotent: ohne Datei-Drift ist
# der git-Diff nach einem Lauf LEER.

$ErrorActionPreference = 'Stop'
Set-Location (Split-Path $PSScriptRoot -Parent)

$dpkPath    = 'SCA.Engine\SCA.Engine.dpk'
