...
| [profiles.md](profiles.md) | **Scan profiles**: what the nine built-in ones contain, how to pick one, and how to write your own. Also in [German](profiles_de.md) and [French](profiles_fr.md). |
