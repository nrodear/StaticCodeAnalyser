# SCA130 — Char-Wert nach PChar umgewandelt - Codepoint wird zur Adresse

![Severity](https://img.shields.io/badge/severity-Error-red) ![Type](https://img.shields.io/badge/type-Bug-red)

> `PChar('A')` ist nicht `PChar("A")` - die Umwandlung deutet den 16-Bit-Codepoint als rohe Speicheradresse
...
| **Typ** | Bug |
| **Detektor-Unit** | `uCharToCharPointerCast.pas` |
| **Schlagworte** | `pointer`, `char`, `undefined-behavior`, `sonardelphi` |
