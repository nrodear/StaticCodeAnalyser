# SCA164 — Routine auf oberster Ebene wird nie gerufen

![Severity](https://img.shields.io/badge/severity-Hint-blue) ![Type](https://img.shields.io/badge/type-Code%20Smell-yellow)

> Eine eigenständige Prozedur oder Funktion in der implementation-Sektion wird nirgends in der Unit gerufen und ist nicht über die interface-Sektion exportiert - toter Code
...
| **Typ** | Code Smell |
| **Detektor-Unit** | `uUnusedRoutine.pas` |
| **Schlagworte** | `dead-code`, `maintainability`, `sonardelphi` |
