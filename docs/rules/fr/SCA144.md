# SCA144 — Comparaison d'égalité ou d'inégalité entre flottants

![Severity](https://img.shields.io/badge/severity-Warning-orange) ![Type](https://img.shields.io/badge/type-Bug-red)

> `a = b` ou `a <> b` entre Single/Double/Extended n'est pas fiable a cause de l'arrondi IEEE-754 - utiliser SameValue ou Math.IsZero

## Métadonnées

| Champ | Valeur |
|---|---|
| **Identifiant de règle** | `SCA144` |
| **Kind** | `FloatEquality` |
| **Sévérité par défaut** | Warning |
| **Type** | Bug |
| **Unité du détecteur** | `uFloatEquality.pas` |
| **Étiquettes** | `floating-point`, `precision`, `sonar50` |
