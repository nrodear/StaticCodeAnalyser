...
// noinspection-file BeginEndRequired, ConcatToFormat, ConsecutiveSection, CyclomaticComplexity, DeepNesting, GroupedDeclaration, IfElseBegin, LengthUnderflow, LongMethod, NestedTry, NilComparison, PublicField, TooLongLine, UnsortedUses, UnusedLocalVar, UnusedParameter, UnusedPublicMember
