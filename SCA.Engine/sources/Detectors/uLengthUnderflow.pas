...
// noinspection-file BeginEndRequired, ConcatToFormat, ConsecutiveSection, CyclomaticComplexity, GroupedDeclaration, IfElseBegin, LongMethod, NilComparison, RedundantJump, StringConcatInLoop, TooLongLine, UnsortedUses, UnusedParameter
