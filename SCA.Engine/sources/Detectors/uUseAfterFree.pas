...
// noinspection-file AvoidOut, BeginEndRequired, CyclomaticComplexity, DeepNesting, GroupedDeclaration, IfElseBegin, LegacyInitializationSection, LongMethod, MultipleExit, NilComparison, RedundantBoolean, TooLongLine, UnsortedUses, UnusedLocalVar, UnusedParameter
